...
Let's bring together what we've learned about `scales`, theming and coloring in `ggplot`, and some extra aesthetics I found [online](http://r-statistics.co/Top50-Ggplot2-Visualizations-MasterList-R-Code.html#Scatterplot%20With%20Encircling).
...
gapminder %>%
  ...
  geom_point() +
  geom_encircle(size = 2, expand = 0.01) + 
  scale_y_log10() +
  scale_x_log10() +
  theme_light() +
  labs(x = "GDP Per Capita", y = "Population", title = "GDP Per Capita vs. Population")
``
